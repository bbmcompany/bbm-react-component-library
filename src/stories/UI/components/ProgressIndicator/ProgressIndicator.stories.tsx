...
const TitleTemplate: ComponentStory<typeof C3ProgressIndicator> = args => (
    <C3Box d={'flex'} displaydirection={'column'}>
        <C3ProgressIndicator {...args} className={'b-m-5'} title={'Completed Tasks:'} primary percent value={37}
                             max={100}/>
        <C3ProgressIndicator {...args} className={'b-m-5'} secondary value={37} max={100}/>
    </C3Box>
);
...
const SizeTemplate: ComponentStory<typeof C3ProgressIndicator> = args => (
    <C3Box d={'flex'} displaydirection={'column'}>
        <C3ProgressIndicator {...args} size={'xs'} className={'b-m-5'} title={'Completed Tasks:'} primary percent
                             value={37} max={100}/>
        <C3ProgressIndicator {...args} size={'s'} className={'b-m-5'} title={'Completed Tasks:'} primary percent
                             value={37} max={100}/>
        <C3ProgressIndicator {...args} size={'m'} className={'b-m-5'} title={'Completed Tasks:'} primary percent
                             value={37} max={100}/>
        <C3ProgressIndicator {...args} size={'l'} className={'b-m-5'} title={'Completed Tasks:'} primary percent
                             value={37} max={100}/>
    </C3Box>
);
