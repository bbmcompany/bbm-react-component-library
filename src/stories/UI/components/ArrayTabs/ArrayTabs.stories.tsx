...
const RelativeTemplate: ComponentStory<typeof C3ArrayTabs> = args => (
    <div className='tabs'>
        ...
        <C3ArrayTabs {...args} gray tabs={['Position', 'Relative', 'Fluid']} className={'b-position-relative'} fluid></C3ArrayTabs>
        <C3ArrayTabs {...args} gray tabs={['Position', 'Relative', 'C3PO']} className={'b-position-relative'}></C3ArrayTabs>
